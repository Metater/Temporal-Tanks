...
var barrel_rotation_0: float
var barrel_rotation_1: float
...
func barrel(t):
	var desired_rotation = lerp_angle(barrel_rotation_0, barrel_rotation_1, t)
	# the given rotation is unit circle based
	desired_rotation = (-desired_rotation) - PI / 2;
	$"BarrelSprite2D".global_rotation = desired_rotation
func set_barrel_rotation(desired_rotation):
	barrel_rotation_0 = desired_rotation
	barrel_rotation_1 = desired_rotation
func index_barrel_rotation(desired_rotation):
	barrel_rotation_0 = barrel_rotation_1
	barrel_rotation_1 = desired_rotation
