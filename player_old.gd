...
func _integrate_forces(state):
	print("_integrate_forces " + str(Time.get_ticks_msec()))

func _ready():
	position = Vector2(200, 200)

# TODO, make Node for player root node, put rigidbody and sprite 2d as siblings, update Sprite global pos every process and use physics interpolation fraction
func _process(_delta):
#	print(Engine.get_physics_interpolation_fraction())
#	print($Sprite2D.global_position)
	pass

# apparently it is bad to set the linear_velocity here?
